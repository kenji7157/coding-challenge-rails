  ...
  describe 'バリデーションチェック' do
    ...
    describe '正常系' do
      context "登録されているプランのIDと紐づく場合" do
        it 'バリデーションエラーにならないこと' do
          commodity_charge = build(:commodity_charge, plan: plan)
    ...
    describe '異常系' do
      ...
      context "kwh_fromがnilの場合" do
        it 'バリデーションエラーになること' do
          commodity_charge = build(:commodity_charge, plan: plan, kwh_from: nil)
      ...
      context "chargeがnilの場合" do
        it 'バリデーションエラーになること' do
          commodity_charge = build(:commodity_charge, plan: plan, charge: nil)
          expect(commodity_charge.valid?).to eq false
        end
      end
    end
